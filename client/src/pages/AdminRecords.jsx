    ...
    <div className="min-h-screen w-full bg-slate-50 font-sans text-slate-800 flex flex-col">
      <nav className="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between shadow-sm shrink-0">
        ...
        <div className="flex items-center gap-8">
          ...
          <button onClick={handleLogout} className="bg-[#4a0080] text-white px-5 py-2.5 rounded-xl font-bold text-sm tracking-wide hover:bg-purple-900 transition-all shadow-md active:scale-95 inline-flex items-center gap-2.5">
              <svg
        ...
        <div className="fixed inset-0 flex items-center justify-center z-110 p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden p-6">
            ...
            <div className="flex gap-3 mt-4">
              <button onClick={() => setFeedbackModalOpen(false)} className="flex-1 py-2 bg-slate-200 rounded-lg font-bold text-slate-700">Cancel</button>
